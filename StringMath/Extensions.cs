...
namespace StringMath
{
    ...
    internal static class Extensions
    {
        ...
        public static ValueExpression<TNum> ToValueExpression<TNum>(this ConstantExpression constantExpr) where TNum : INumber<TNum>
        {
            TNum value = TNum.Parse(constantExpr.Value, CultureInfo.InvariantCulture.NumberFormat);
            return new ValueExpression<TNum>(value);
        }

        public static TNum ToFactorial<TNum>(this TNum value) where TNum : INumber<TNum>
        {
            int num = Convert.ToInt32(value, CultureInfo.InvariantCulture.NumberFormat);

            if (num > 170)
            {
                throw new InvalidOperationException("Result would be too big.");
            }
            ...
            return TNum.Create(_factorials[num]);
        }

        #region Factorial

        private static readonly Dictionary<int, double> _factorials = new()
        {
            [0] = 1d,
            [1] = 1d,
            [2] = 2d,
